...
- 生效日期: 2026-07-24
- 案例: P-02
- 支持记录: [PX-20260721-P02](records/2026-07/2026-07-21.md), [PX-20260723-P02](records/2026-07/2026-07-23.md), [PX-20260724-P02](records/2026-07/2026-07-24.md), [PX-20260804-P02](records/2026-08/2026-08-04.md)
- 时间窗口: 2026-07-21, 2026-07-23, 2026-07-24, 2026-08-04

### 发现

在已记录的保护机制, HTTP 404 与 Crossref rows 校验 HTTP 400 材料中, 当证据允许多个原因时, 判断保持证据适用范围并要求关键条件, 可以避免把错误状态扩大为单一事实
...
- 仅覆盖支持记录中的 GitHub 保护机制, HTTP 404 与 Crossref rows=1001 对应 HTTP 400 材料
- 不推广到其他 HTTP 400 原因, 其他错误状态, 其他 API 或所有 Agent
- 同日多个 Trial 只共同构成一个时间窗口

### 复验与失效条件

在新的日期窗口改用另一项非 GitHub API 与 HTTP 401, 429 或 503
