...
| 来源文件 | [README.md](https://github.com/OpenHands/OpenHands/blob/46f4d1871680cb05bb68ac5bfeb23b8e3b849ec1/README.md) |
| 来源版本 | `46f4d1871680cb05bb68ac5bfeb23b8e3b849ec1` |
| 来源目录 Tree | `3cdf8eb0a3c0d7ab451aa9434ee01572b1b330e5` |
| 来源内容 Blob | `efbac0df3d073db0bee3eb1e1cc20fb4956407ba` |
| 摄取时间 | `2026-07-30T05:52:33.874733+00:00` |
| 归属层 | `complex-agent-systems` |
| 可信度 | `1.0` |
| 记忆实体 | `external_doc_openhands_openhands_readme_md` |
...
docker run -it --rm \
  ...
  ghcr.io/openhands/agent-canvas:1.7.1 # x-release-please-version
```
...
+++ efbac0df3d073db0bee3eb1e1cc20fb4956407ba
...
@@ -96,7 +96,7 @@
   ...
   -v "$HOME/.openhands:/home/openhands/.openhands" \
   -v "${PROJECTS_PATH}:/projects" \
-  ghcr.io/openhands/agent-canvas:1.7.0 # x-release-please-version
+  ghcr.io/openhands/agent-canvas:1.7.1 # x-release-please-version
 ```
